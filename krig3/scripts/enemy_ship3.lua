...
function on_update(this, elapsedTime)
  ...
  if ( this_position[2] < 15 ) then
    ...
    -- Angle a bit up.
    if ( relative_pos < 10 ) then krig.object.set_velocity(this, 2.0, 5.0, 0.0) end
    -- Go straight up.
    if ( relative_pos < 5 )  then krig.object.set_velocity(this, 10.0, 10.0, 0.0) end
    return
  end
  ...
  if ( this_position[2] >= 15 ) then
    ...
    if this_position[2] > 20 then krig.object.set_velocity(this, 18.0, 5.0, 0.0) end
    -- Full retreat.
    if relative_pos > 10 then krig.object.set_velocity(this, 20.0, 0.0, 0.0) end

...
function on_load(terrain)
  ...
  -- place pine trees
  obj = addObject("./scripts/pinetree.lua", 145.0, -25.0)
  obj = addObject("./scripts/pinetree.lua", 150.0, -25.0)
  obj = addObject("./scripts/pinetree.lua", 185.0, -20.0)
  obj = addObject("./scripts/pinetree.lua", 190.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 210.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 213.0, -12.0)
  obj = addObject("./scripts/pinetree.lua", 216.0, -13.0)
  obj = addObject("./scripts/pinetree.lua", 255.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 265.0, -20.0)
  obj = addObject("./scripts/pinetree.lua", 280.0, -20.0)
  obj = addObject("./scripts/pinetree.lua", 285.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 300.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 310.0, -25.0)
  obj = addObject("./scripts/pinetree.lua", 313.0, -28.0)
  obj = addObject("./scripts/pinetree.lua", 315.0, -24.0)
  obj = addObject("./scripts/pinetree.lua", 355.0, -10.0)
  obj = addObject("./scripts/pinetree.lua", 365.0, -15.0)
  obj = addObject("./scripts/pinetree.lua", 370.0, -20.0)
  obj = addObject("./scripts/pinetree.lua", 370.0, -65.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 375.0, -60.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 380.0, -55.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 705.0, -45.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 708.0, -42.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 715.0, -45.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 725.0, -40.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 735.0, -45.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 740.0, -42.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 980.0, -75.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 985.0, -70.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 990.0, -80.0, 4.0)
  obj = addObject("./scripts/pinetree.lua", 995.0, -75.0, 4.0)

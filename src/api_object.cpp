...
static int orient_on_terrain(lua_State *L) {
  ...
  object->orientOnTerrain(g_script_engine->getCurrentLevel()->getTerrain(), rotation);
...
static int set_height_from_terrain(lua_State *L) {
  ...
  object->setHeightFromTerrain(g_script_engine->getCurrentLevel()->getTerrain(), offset);
